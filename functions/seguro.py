...
class Automovel(Seguro):
    def __init__(self, modelo, ano, placa):
        modelo = (
            modelo.title()
        )  # Formata o modelo para ter a primeira letra de cada palavra em maiúscula
...
class Vida(Seguro):
    def __init__(self, valor_segurado, beneficiarios):
        beneficiarios = [
            b.title() for b in beneficiarios
        ]  # Formata cada beneficiário para ter a primeira letra em maiúscula
